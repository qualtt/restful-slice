...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "../order-service")))
...
class TestOrderManager:
    ...
    def test_invalid_status_transition(self):
        ...
        with pytest.raises(InvalidStatusTransitionError, match="Невозможно изменить статус"):
